...
namespace Google.Maps
{
	public class LatLngComparer : IEqualityComparer<LatLng>
	{
		...
		public static LatLngComparer Within(float epsilon) => new LatLngComparer(epsilon);
		...
		public int GetHashCode(LatLng value) => value.Latitude.GetHashCode() ^ value.Longitude.GetHashCode();
