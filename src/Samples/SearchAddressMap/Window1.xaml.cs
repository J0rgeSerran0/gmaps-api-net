...
namespace SearchAddressMap
{
	...
	public partial class Window1 : Window
	{
		...
		private void headingSlider_ValueChanged(object sender, RoutedPropertyChangedEventArgs<double> e) => refreshImage();

		private void pitchSlider_ValueChanged(object sender, RoutedPropertyChangedEventArgs<double> e) => refreshImage();

		private void Window_Loaded(object sender, RoutedEventArgs e) => zoomLabel.Content = zoomSlider.Value.ToString("0x");

		private void mapTypeComboBox_SelectionChanged(object sender, SelectionChangedEventArgs e) => refreshImage();

		private void pitchSlider_MouseDoubleClick(object sender, System.Windows.Input.MouseButtonEventArgs e) => pitchSlider.Value = 0;

		private void headingSlider_MouseDoubleClick(object sender, System.Windows.Input.MouseButtonEventArgs e) => headingSlider.Value = 0;

		private void txtGoogleApiKey_LostFocus(object sender, RoutedEventArgs e) => GoogleSigned.AssignAllServices(new GoogleSigned(txtGoogleApiKey.Text));
